...
public class Event implements Serializable {
	...
	public String getTxapelketa() {
		return txapelketa;
	}

	public void setTxapelketa(String txapelketa) {
		this.txapelketa = txapelketa;
	}
	...
	public Event(Integer eventNumber, String description, Date eventDate, String kirola, String txapelketa) {
	...
	public Event(String description, Date eventDate, String kirola, String txapelketa) {
		this.description = description;
		this.eventDate=eventDate;
		this.kirola=kirola;
		this.txapelketa=txapelketa;
